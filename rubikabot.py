...
@router.callback_query(F.text == "مشاهده ی تحلیل های فوق حرفه ای غلام")
async def message(message : Message):
    await message.edit_text(text="کدام تحلیل را میخواهید مشاهده کنید.",reply_markup=menu_keyboard())
